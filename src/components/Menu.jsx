...
function Menu() {
  ...
  return (
    <nav class="flex items-center relative justify-between px-2 py-6 w-full">
      <div>
        <h1 className="text-white text-3xl font-bold ml-9">MUSE ART</h1>
      </div>
      <ul
        id="drawer"
        role="menu"
        class="sm:gap-3 transition-left ease-[cubic-bezier(0.4, 0.0, 0.2, 1)] delay-150  sm:flex  flex flex-col cursor-pointer absolute min-h-screen -left-48 sm:static w-48 top-0 bg-white sm:shadow-none shadow-xl sm:bg-transparent sm:flex-row sm:w-auto sm:min-h-0  "
      >
        ...
        <li class="font-medium text-sm p-3 sm:p-0 sm:hover:bg-transparent text-primary">
          <a href="#" className="dark:text-white text-lg">
            Inicio
          </a>
        </li>
        <li class="font-medium text-sm p-3 cursor-pointer  sm:p-0 sm:hover:bg-transparent text-gray-600 hover:text-primary transition-colors">
          <a href="#" className="dark:text-white text-lg">
            Populares
          </a>
        </li>
      ...
      <div class="flex gap-3 items-center">
        {/* icones  ao lado do perfil */}
        
        <img width="34" height="34" className="cursor-pointer" src="./src/assets/amigos.png" />
        <img width="34" height="34" className="cursor-pointer" src="./src/assets/bater-papo.png" />
